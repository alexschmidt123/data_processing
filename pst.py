...
class PST:
    ...
    def transform(self, image_path):
        image_org = io.imread("test_img/lena.tif")
        # the input of rgb2gray funtion should be a colorful image.
        ...
        # convert cartesian X and Y vectors to polar vectors (THETA, RHO)
        ...
        # convert cartesian FX and FY vectors to polar vectors (FTHETA, FRHO)
